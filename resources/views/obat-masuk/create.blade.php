    ...
    <form method="POST" action="{{ route('obat-masuk.store') }}" class="space-y-5">
        ...
        <div class="space-y-1.5 pb-2">
            ...
            <textarea name="keterangan" rows="3"
                      ...
                      placeholder="Contoh: Restock bulanan dari supplier utama (opsional)">{{ old('keterangan') }}</textarea>
        </div>
